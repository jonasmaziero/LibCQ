...
some new functionalities that are easier to implement in C. Further explanations and
...
for it. Also, I usually make some tests before realesing the code, but nothing too significant. 
