...
void rpvg_test(){
  ...
  for l in range(0, ni):
    x[l] = l*delta;  y1[l] = ct[l][0]/ns;
    y2[l] = ct[l][1]/ns;  y3[l] = ct[l][2]/ns
  import matplotlib.pyplot as plt;  plt.plot(x,y1,label='p0');
  plt.plot(x,y2,label='p1');  plt.plot(x,y3,label='p2')
